...
# Usage: require and call FakeMunichFuture.generate!
# This script deletes and recreates the Munich Fall Reading Challenge starting one week in the future,
# along with groups, users, readings, and enrollments.
