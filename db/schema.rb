...
ActiveRecord::Schema[8.1].define(version: 2026_05_21_191545) do
  ...
  create_table "challenges", force: :cascade do |t|
    ...
    t.boolean "hide_copyright", default: false, null: false
  ...
  create_table "user_badges", force: :cascade do |t|
    ...
    t.index ["user_id", "badge_key", "challenge_id"], name: "index_user_badges_on_user_id_and_badge_key_and_challenge_id", unique: true
  ...
  create_table "verse_messages", force: :cascade do |t|
    ...
    t.index ["reading_id"], name: "index_verse_messages_on_reading_id"
