  ...
  def console_nav_groups(challenge)
    [
      { key: "challenge", items: [
        ...
        console_nav_item("schedule", edit_challenge_manage_schedule_path(challenge), %w[schedules]),
      ...
      { key: "people", items: [
        ...
        console_nav_item("groups", challenge_manage_groups_path(challenge), %w[groups])
      ] },
      { key: "content", items: [
        console_nav_item("chapters", challenge_manage_chapters_path(challenge), %w[chapters]),
