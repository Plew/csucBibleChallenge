...
module BadgeCatalog
  ...
  BADGES = [
    ...
    Badge.new(key: "perfect_week", category: "perfect", icon: "star", threshold: 7, check_type: :perfect_record),
    Badge.new(key: "perfect_month", category: "perfect", icon: "star", threshold: 30, check_type: :perfect_record),
