    ...
    if @user_challenge
      ...
      if @selected_reading
        ...
        @selected_reading_verses = verses.map do |v|
          verse_likes = @selected_reading.verse_likes.where(verse_number: v.verse_number)
          user_liked = verse_likes.exists?(user_id: current_user.id)
